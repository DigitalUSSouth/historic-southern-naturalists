...
class Content {
  ...
  public function retrieveResults() {
    ...
    $this->content = json_decode(file_get_contents("http://digital.tcl.sc.edu:81/dmwebservices/?q=dmQuery/hsn/CISOSEARCHALL^*^any/contri!covera!date!descri!publis!relati!subjec!title/0/1024/0/0/0/0/0/1/json"), true);
  }
