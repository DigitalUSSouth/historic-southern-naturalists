...
class PlaylistMenuItem extends Component {
  ...
  createEl() {
    ...
    descEl.className = "vjs-playlist-desc";
    descEl.appendChild(document.createTextNode(descText));
    descEl.setAttribute("description", descText);
    descEl.style.fontSize = "x-small";
